...
extern __m128 __ptx_tex1D(float* ptr, float coordinate);//{return *(__m128*)ptr;}
extern __m128 __ptx_tex2D(float* ptr, __m128 coordinates);//{return *(__m128*)ptr;}
extern __m128 __ptx_tex3D(float* ptr, __m128 coordinates);//{return *(__m128*)ptr;}
...
extern "C" void test_textureFetches(DataStruct* data)
{
  ...
  __m128 test = __ptx_tex1D((float*)(&__ptx_texture_dataf),0);
  float f = ((float*)&test)[0];
  float f2 = ((float*)&test)[1];
  float f3 = ((float*)&test)[2];
  data->fa[0] = f+f2+f3;
...
Vec3f __ptx_const_position;
Matrix4f __ptx_const_matrix;
extern "C" void test_reg2Const(DataStruct* data)
{
  Vec4f worldPos = __ptx_const_matrix * __ptx_const_position;
...
#define dataS __ptx_const_data_dev
#define lightsS __ptx_const_lights_dev
